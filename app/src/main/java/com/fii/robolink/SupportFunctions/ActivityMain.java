...
import com.fii.robolink.MainFunctions.FragmentAudioControl;
import com.fii.robolink.MainFunctions.FragmentCamera;
import com.fii.robolink.MainFunctions.FragmentDevices;
import com.fii.robolink.MainFunctions.FragmentMain;
...
public class ActivityMain extends ActivityBase implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setItemIconTintList(null);//设置取消默认点击颜色变化
        navigationView.getMenu().findItem(R.id.navigation_home).setIcon(R.mipmap.ic_home);

        customTitleBar =  findViewById(R.id.bar_view) ;
        customTitleBar.setSplitMode(true);//设置成分开模式
